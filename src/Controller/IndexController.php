...
class IndexController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $sliders2a = $this->data->findNodeByCategoryAndTag('series-500', $locale, 'home-slider-2', 12);
        $sliders2b = $this->data->findNodeByCategoryAndTag('series-600', $locale, 'home-slider-2', 12);
